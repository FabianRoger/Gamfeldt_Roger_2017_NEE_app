...
[![DOI](https://zenodo.org/badge/87823234.svg)](https://zenodo.org/badge/latestdoi/87823234)

This is the code for the shiny app published alongside the article entitled *Revisiting the biodiversity-ecosystem multifunctionality relationship* by Gamfeldt and Roger 2017 (Nature Ecology and Evolution) 

### running the app

you can access  the app online here:

[https://fabianroger.shinyapps.io/multifunctionality-simulations/](https://fabianroger.shinyapps.io/multifunctionality-simulations/)

To run the app, from within R run
...
You need to have the following packages installed to run the app. (Older or newer package versions might work but it is not tested):
...
Below follows the description of the app. The identical document is also accessible from within the app under the "Description" tab. 
